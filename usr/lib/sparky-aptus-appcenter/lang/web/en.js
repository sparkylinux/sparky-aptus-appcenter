...
dict.entries['web']['conkeror'] = "Conkeror is a keyboard-oriented, highly-customizable, highly-extensible web browser based on Mozilla XULRunner, written mainly in JavaScript, and inspired by exceptional software such as Emacs and vi.";
dict.entries['web']['cyberfox'] = "Cyberfox is designed by 8pecxstudios. Taking over where Mozilla left off. Working to make a fast, stable and reliable x64-bit web browser accessible to all. Cyberfox is powered by Mozilla Firefox source code.";
dict.entries['web']['dillo'] = "Dillo is a minimalistic web browser particularly intended for older or slower computers and embedded systems.";
dict.entries['web']['dooble'] = "Dooble is a free and open source Web browser that was created to improve privacy. Dooble uses Qt for its user interface.";
...
dict.entries['web']['epiphany'] = "GNOME Web (originally called Epiphany from 2003-2012) is a free and open-source web browser for the GNOME desktop environment.";
dict.entries['web']['falkon'] = "Lightweight web browser based on libqtwebkit.";
dict.entries['web']['firefoxesr'] = "Mozilla Firefox web browser - Extended Support Release (ESR). Firefox ESR is a powerful, extensible web browser with support for modern web application technologies.";
dict.entries['web']['firefoxlatest'] = "The latest stable version of Mozilla Firefox web browser. Firefox is a powerful, extensible web browser with support for modern web application technologies.";
dict.entries['web']['googlechrome'] = "Google Chrome is a freeware web browser developed by Google. It is partly based on open source solutions, such as WebKit and Mozilla.";
dict.entries['web']['icecat'] = "Its main advantage is an ethical one: it is entirely free software. While the Firefox source code from the Mozilla project is free software, they distribute and recommend non-free software as plug-ins and addons.";
...
dict.entries['web']['iron'] = "SRWare Iron is a free web browser, and an implementation of Chromium by SRWare of Germany. It primarily aims to eliminate usage tracking and other privacy-compromising functionality that the Google Chrome browser includes.";
dict.entries['web']['konqueror'] = "Konqueror is the KDE web browser and advanced file manager. Konqueror is a standards-compliant web browser, supporting HTML 4.01, Java, JavaScript, CSS3, and Netscape plugins such as Flash.";
...
dict.entries['web']['midori'] = "Midori is a lightweight web browser. It uses the WebKit rendering engine and the GTK+ 3 interface.";
...
dict.entries['web']['netsurf'] = "Small as a mouse, fast as a cheetah and available for free. NetSurf is a multi-platform web browser for RISC OS, UNIX-like platforms (including Linux), Mac OS X, and more.";
dict.entries['web']['opera'] = "Opera is a web browser for Windows, macOS, and Linux operating systems developed by Opera Software. Opera is a free software, released under Freeware license, but it is source-closed application.";
dict.entries['web']['otter'] = "Otter Browser aims to recreate the best aspects of the classic Opera (12.x) UI using Qt5.";
dict.entries['web']['palemoon'] = "Pale Moon is an Open Source, Goanna-based web browser available for Microsoft Windows and Linux (with other operating systems in development), focusing on efficiency and ease of use.";
...
dict.entries['web']['seamonkey'] = "SeaMonkey is a free and open-source Internet suite. It is the continuation of the former Mozilla Application Suite, based on the same source code.";
dict.entries['web']['torbrowser'] = "The Tor Browser is a version of Mozilla Firefox that has been modified by the Tor Project for enhanced security and privacy.";
dict.entries['web']['vivaldi'] = "Vivaldi is a freeware, cross-platform web browser developed by Vivaldi Technologies, a company founded by Opera Software co-founder and former CEO Jon Stephenson von Tetzchner and Tatsuki Tomita.";
...
dict.entries['web']['waterfox'] = "Free, open and private web browser focuses on giving users choice while also helping make the world a better place.";
