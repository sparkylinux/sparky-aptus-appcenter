//Spanish localization file for Web
// Copyright 2017 Pawel "pavroo" Pijanowski <pavroo@onet.eu>
// Under the GNU GPL v3
// Translated by 2017/11/02 by seacat
...
// web browsers
dict.entries['web']['brave'] = "Brave es una navegador web libre y de código abierto basado en el navegador web Chromium y su motor Blink, anunciado por el cofundador del Proyecto Mozilla y creador de JavaScript, Brendan Eich.";
dict.entries['web']['chromium'] = "Chromium es un proyecto de navegador web de código abierto iniciado por Google, para proporcionar el código fuente para el navegador propietario Google Chrome.";
dict.entries['web']['conkeror'] = "Conkeror es un navegador web basado en Mozilla XULRunner, orientado al teclado, altamente personalizable y extensible, escrito principalmente en JavaScript, e inspirado por software excepcional tal como Emacs y vi.";
dict.entries['web']['cyberfox'] = "Cyberfox está diseñado por 8pecxstudios. Tomando el control donde lo dejó Mozilla. Trabajando para hacer un navegador web de 64 bits rápido, estable, confiable y accesible para todos. Cyberfox funciona con el código fuente de Mozilla Firefox.";
dict.entries['web']['dillo'] = "Dillo es un navegador web minimalista pensado principalmente para computadoras viejas o lentas y sistemas embebidos.";
dict.entries['web']['dooble'] = "Dooble es un navegador web libre y de código abierto, que se creó para mejorar la privacidad. Dooble usa Qt para su interfaz de usuario.";
...
dict.entries['web']['epiphany'] = "GNOME Web (llamado Epiphany originalmente de 2003-2012) es un navegador web libre y de código abierto para el entorno de escritorio GNOME.";
dict.entries['web']['falkon'] = "Lightweight web browser based on libqtwebkit.";
dict.entries['web']['firefoxesr'] = "El navegador web Mozilla Firefox - Edición de Soporte Expendido (ESR por sus siglas en inglés). Firefox ESR es un navegador web potente y extensible con soporte para tecnologías de aplicaciones web modernas.";
dict.entries['web']['firefoxlatest'] = "Última versión del navegador web Mozilla Firefox. Firefox es un navegador web potente y extensible con soporte para tecnologías de aplicaciones web modernas.";
dict.entries['web']['googlechrome'] = "Google Chrome es un navegador web freeware desarrollado por Google. Está parcialmente basado en soluciones de código abierto, tales como WebKit y Mozilla.";
dict.entries['web']['icecat'] = "Su principal ventaja es ética: es completamente de código abierto. Mientras que el código fuente de Firefox del Proyecto Mozilla es software libre, ellos distribuyen y recomiendan software no libre como complementos y extensiones.";
...
dict.entries['web']['iron'] = "SRWare Iron es un navegador web libre y una implementación de Chromium por SRWare de Alemania. Apunta principalmente a eliminar el uso de seguimiento y otras funcionalidades que comprometen la privacidad que el navegador Google Chrome incluye.";
dict.entries['web']['konqueror'] = "Konqueror es el navegador web y administrador avanzado de archivos de KDE. Konqueror es un navegador web que cumple con los estándares, soportando HTML 4.01, Java, JavaScript, CSS3, y complementos de Netscape tal como Flash.";
...
dict.entries['web']['midori'] = "Midori es un navegador web ligero. Usa el motor de renderizado WebKit y las interfaces GTK+ 3.";
...
dict.entries['web']['netsurf'] = "Pequeño como un ratón, veloz como el chita y disponible libremente. NetSurf es un navegador web multiplataforma para plataformas RISC OS, del tipo UNIX (incluyendo Linux), Mac OS X, y más.";
dict.entries['web']['opera'] = "Opera es un navegador web para los sistemas operativos Windows, macOS, y Linux desarrollado por Opera Software. Opera es software libre, liberado bajo licencia Freeware, pero es una aplicación de código cerrado.";
dict.entries['web']['otter'] = "El navegador Otter apunta a recrear los mejores aspectos de la interfaz clásica de Opera (12.x) UI usando Qt5.";
dict.entries['web']['palemoon'] = "Pale Moon es un navegador web de código abierto, basado en Goanna disponible para Microsoft Windows y Linux (con otros sistemas operativos en desarrollo), enfocado en la eficiencia y facilidad de uso.";
...
dict.entries['web']['seamonkey'] = "SeaMonkey es una suite de Internet libre y de código abierto. Es la continuación de la anterior Suite de Aplicaciones Mozilla, basada en el mismo código fuente.";
dict.entries['web']['torbrowser'] = "El navegador Tor es una versión de Mozilla Firefox que fue modificada por el Proyecto Tor para mejorar la seguridad y la privacidad.";
dict.entries['web']['vivaldi'] = "Vivaldi es un navegador web freeware, de plataforma cruzada desarrollado por Vivaldi Technologies, una compañía fundada por el co-fundador y antiguo CEO de Opera Software Jon Stephenson von Tetzchner y Tatsuki Tomita.";
...
dict.entries['web']['waterfox'] = "Navegador web libre, abierto y privado que se enfoca en darle una oportunidad a los usuarios, a la vez que ayuda a hacer del mundo un mejor lugar.";
